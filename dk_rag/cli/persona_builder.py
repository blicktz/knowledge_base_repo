...
class PersonaBuilderCLI:
    ...
    def analyze_knowledge(self, args):
        ...
        analysis = self.knowledge_indexer.analyze_knowledge_base()
...
Examples:
  ...
  python -m dk_rag.cli.persona_builder build-kb --documents-dir /path/to/docs
  
  # Extract persona from documents
  python -m dk_rag.cli.persona_builder extract-persona --documents-dir /path/to/docs --name influencer_name
  
  # List available personas
  python -m dk_rag.cli.persona_builder list-personas
  
  # Search knowledge base
  python -m dk_rag.cli.persona_builder search "mental models for productivity"
  
  # Analyze knowledge base
  python -m dk_rag.cli.persona_builder analyze
            """
        )
